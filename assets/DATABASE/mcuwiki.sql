...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 11 fév. 2022 à 16:55
...
CREATE TABLE `film` (
  ...
  `date` date NOT NULL,
  `date_fictive` date DEFAULT NULL,
