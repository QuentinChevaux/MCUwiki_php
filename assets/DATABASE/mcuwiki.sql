...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 03 fév. 2022 à 16:49
...
INSERT INTO `film` (`id`, `titre`, `description`, `date`, `duree`, `image`) VALUES
(1, 'Iron Man', 'Alors qu\'il fait l\'essai d\'une arme de son invention en Afghanistan, le milliardaire Tony Stark est capturé par des insurgés qui le forcent à travailler pour eux. Mais à leur insu, le scientifique crée pour lui-même une armure superpuissante au moyen de laquelle il s\'évade et rentre aux États-Unis. Transformé par son aventure, il décide de mettre son génie et sa fortune au service du Bien.', '2008-03-30', 126, 'ironman1.jpg'),
